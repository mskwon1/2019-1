...
![1558570975086](../../typora_images/1558570975086.png)

- 실행
  - 사용시 **그루핑 기준 컬럼** / 집단 함수에서 사용되는 **숫자형 데이터 컬럼들의 튜플집합**을 새로 만듬, 그 이외의 컬럼들은 메모리에서 제거(MySQL은 아님)
    - 따라서 이들 이외의 컬럼은 SELECT 절에서 에러발생

##### HAVING 절

- GROUP BY절의 기준 항목이나 그룹의 집단 함수를 이용할 조건을 표시
- **GROUP BY절에 의해 만들어진 그룹들 중**, **추가의 제한조건**을 두어 이 조건을 만족하는 그룹만 출력
- GROUP BY절 뒤에 위치
  ![1558572907973](../../typora_images/1558572907973.png)
  - WHERE 튜플 조건식 : 튜플조건식이 TRUE인 **튜플**만 선택(집단함수 사용 불가)
...
![1558573287019](../../typora_images/1558573287019.png)
...
- 모든 부서의 월별 입사자의 평균 급여를 구하여라
  ![1558573682869](../../typora_images/1558573682869.png)

  ![1558573697297](../../typora_images/1558573697297.png)
  ![1558573714135](../../typora_images/1558573714135.png)
  ![1558573731025](../../typora_images/1558573731025.png)
...
- 팀별로 포지션별 인원수, 그리고 팀별 전체 인원수를 구하라. 단 데이터가 없는 경우 0으로 표시
  ![1558574004967](../../typora_images/1558574004967.png)
  ![1558574023485](../../typora_images/1558574023485.png)
...
![1558575629127](../../typora_images/1558575629127.png)
...
- 특징
  ...
  ![1558575812160](../../typora_images/1558575812160.png)
...
- Windows functions : RANK()와 ROW_NUMBER()함수
  - RANK() : 동점자 처리
  - ROW_NUMBER() : 일련번호 부여, Pagination에 활용

![1558578582775](../../typora_images/1558578582775.png)

- MySQL에서
  - RANK() 함수를 사용한 컬럼명에 RANK를 사용할 수 없음
  - ROW_NUMBER() 함수를 사용한 컬럼명에 ROW_NUMBER를 사용할 수 없음

- MySQL의 Limit Clause
  - 첫번째 파라미터 : 결과에서 리턴할 첫번째 레코드의 위치(offset)
    - 생략가능, 생략되면 디폴트 = 0
  - 두번째 파라미터 : 리턴할 레코드의 최대 수
    ![1558579045909](../../typora_images/1558579045909.png)

##### Oracle

- 사원에서 급여가 높은 3명만 내림차순으로 출력
  ![1558579576355](../../typora_images/1558579576355.png)

##### SQL Server

- 사원 테이블에서 급여가 높은 2명만 내림차순으로 출력(TOP 함수 사용)
  ![1558579620913](../../typora_images/1558579620913.png)
- 동점자 처리
  ![1558579638263](../../typora_images/1558579638263.png)
